        ...
        <div class="container-fluid" >
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                    <form class="needs-validation" novalidate  method="post" action="device<c:if test="${device.id != 0}" >?macAddress=${device.macAddress } </c:if>">    
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="macAddressDevice" id="macAddressDevice" placeholder="" value="${device.macAddress}" required>
                                <div class="invalid-feedback">
