...
public class DeviceDaoImpl implements DeviceDao {
    ...
    public List<Device> lister() {
        ...
        try {
            ...
            resultat = statement.executeQuery("SELECT d.name,d.id, d.type, d.macAddress,e.id, e.name FROM device AS d INNER JOIN employee AS e ON d.id_employee = e.id");
    ...
    public Device find(int id) {
        ...
        try {
            connexion = daoFactory.getConnection();
            statement = connexion.createStatement();
            resultat = statement.executeQuery("SELECT d.id, d.name, type, macAddress,e.id, e.name FROM device AS d INNER JOIN employee AS e WHERE d.id =" + id +"  AND d.id_employee = e.id;");
