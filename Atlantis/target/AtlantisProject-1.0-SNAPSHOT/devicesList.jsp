                        ...
                        <table class="table table-striped table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="${pageContext.request.contextPath}/device?macAddress=${device.macAddress}">Edit</a></td>
                                    <td><a href="${pageContext.request.contextPath}/deleteDevice?macAddress=${device.macAddress}">Delete</a></td>
                                </tr>
                                </c:forEach>
                            </tbody>
                        </table>
